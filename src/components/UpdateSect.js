...
const handleNewTalkingPoint=(e)=>{
    ...
    return(
        <div>
        {showEditFormSection&&<div className="sectionPlace"><h3>{props.section.title} &nbsp; <a onClick= {sectionSwitch}style={{fontSize:"20px", textDecoration:"underline"}}> Edit</a><i onClick={handleDelete} className="far fa-trash-alt"></i></h3><h3 className="timeDisplay">{time}</h3></div>}
        ...
        <i onClick={handleDelete} className="far fa-trash-alt"></i>
         ...
         { plusTalkAdd && <button onClick={handleShowTalkpointForm}>+ Talking Point</button>}
          ...
          <form className="sectionForm" onSubmit ={handleAdd}>
